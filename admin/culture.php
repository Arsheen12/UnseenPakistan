        ...
        >
          ...
          ?>
              <tr class="">
                ...
                <td scope="row"><a href="update7.php?id=<?php echo $fetch['id'];?>" class="btn btn-warning">Edit</a> <a href="culture_delete.php?id=<?php echo $fetch['id'];?>" class="btn btn-danger">Delete</a></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
