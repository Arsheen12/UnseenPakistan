...
if(isset($_POST['edit'])){
    ...
    $b_text = $_POST['btext'];
    $query = "UPDATE header_section SET Heading='$heading', Text='$text', Btn_text='$b_text' WHERE Id='$id';";
    ...
    <div class="body-wrapper">
      ...
      <div class="row">
       <form action="update.php" method="post">
        <?php
            $query="SELECT header_section.Id,header_section.Heading,header_section.Text,header_section.Btn_text FROM header_section where Id='$id';";
            $execute = mysqli_query($connect,$query);
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    class="form-control"
                    name="btext"
                    id="" value="<?php echo $fetch['Btn_text'];?>"
                />
                </div>
                <button
                    type="submit"
